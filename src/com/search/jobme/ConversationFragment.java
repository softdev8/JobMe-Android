...
import com.search.jobme.OpponentsFromCallAdapter.ViewHolder;
import com.search.jobme.until.RTCGLVideoView;
 ...
 */
@SuppressLint("NewApi")
public class ConversationFragment extends Fragment implements Serializable, QBRTCClientVideoTracksCallbacks, QBRTCSessionConnectionCallbacks, ChatActivity.QBRTCSessionUserCallback, OpponentsFromCallAdapter.OnAdapterEventListener {
    ...
    private List<QBUser> allUsers = new ArrayList<QBUser>();
//    private LinearLayout actionVideoButtonsLayout;
    ...
    public static ConversationFragment newInstance(List<QBUser> opponents, String callerName,
                                                   ...
                                                   Map<String, String> userInfo, ChatActivity.StartConversetionReason reason,
                                                   String sesionnId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            startReason = getArguments().getInt(ChatActivity.START_CONVERSATION_REASON);
            sessionID = getArguments().getString(ChatActivity.SESSION_ID);
            callerName = getArguments().getString(ChatActivity.CALLER_NAME);
    ...
    private void initSessionListener() {
    	mParent.addVideoTrackCallbacksListener(this);
    }
    ...
    public void onStart() {
        ...
        super.onStart();
        QBRTCSession session = mParent.getCurrentSession();
        if (!isMessageProcessed) {
            if (startReason == ChatActivity.StartConversetionReason.INCOME_CALL_FOR_ACCEPTION.ordinal()) {
        ...
        mParent.addTCClientConnectionCallback(this);
        mParent.addRTCSessionUserCallback(this);
    }
...
//        actionVideoButtonsLayout = (LinearLayout) view.findViewById(R.id.element_set_video_buttons);
    ...
    private void setGrid(int columnsCount, int rowsCount) {
        ...
        OpponentsFromCallAdapter opponentsAdapter = new OpponentsFromCallAdapter(getActivity(), opponents, cellSize,
        		recyclerView.getMeasuredHeight(), gridWidth, columnsCount, (int) itemMargin,
                isVideoEnabled);
    ...
    private int defineMinSize(int measuredWidth, int measuredHeight, int columnsCount, int rowsCount, float padding) {
        int cellWidth = measuredWidth;
        int cellHeight = measuredHeight;
    ...
    public void onStop() {
        ...
        mParent.removeRTCClientConnectionCallback(this);
        mParent.removeRTCSessionUserCallback(this);
    }
    ...
    private void toggleCamera(boolean isNeedEnableCam) {
        QBRTCSession currentSession = mParent.getCurrentSession();
